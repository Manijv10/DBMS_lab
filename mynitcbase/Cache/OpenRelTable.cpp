...
OpenRelTable::~OpenRelTable(){
    ...
    // NOTE: they are never changed because the attributes of relcat and attrcat are never modified.Therfore no need to check whether write back is necessary or not
    for(int i = 0; i < 2; i++){
